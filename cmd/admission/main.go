...
import (
	...
	"github.com/kai-scheduler/KAI-scheduler/pkg/admission/webhook/v1alpha2/gpugroup"
...
func registerPlugins(app *app.App) error {
	...
	admissionGPUGroupPlugin := gpugroup.New()
	admissionPlugins.RegisterPlugin(admissionGPUGroupPlugin)
